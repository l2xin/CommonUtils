...
namespace UnityEngine.UI
{
    ...
    [AddComponentMenu("UI/TText", 10)]
    public class TText : TMaskableGraphic, ILayoutElement
    {
    ...
    public static class TFontUpdateTracker
    {
        static Dictionary<Font, HashSet<TText>> m_Tracked = new Dictionary<Font, HashSet<TText>>();

        public static void TrackText(TText t)
        {
            if (t.font == null)
                return;

            HashSet<TText> exists;
        ...
        public static void UntrackText(TText t)
        {
            if (t.font == null)
                return;
